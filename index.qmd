...
To minimize $L(\theta)$: set **gradient** equal to zero and solve for $\theta$
...
- Gradient: direction of steepest ascent ⬆️
- Negative gradient: **steepest descent** ⬇️
...
::: {.incremental}
- Neural networks = high-dimensional optimization
- **Partial derivatives** tell us how to adjust each parameter
- **Gradient** points toward steepest ascent
- Modern deep learning uses sophisticated variants (Adam, RMSprop)
- Calculus gives you the foundation to understand these algorithms
:::
