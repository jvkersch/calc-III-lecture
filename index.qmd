...
::: {.incremental}
- Classical calculus → Modern applied mathematics
- Single-variable thinking → Multivariate reality
- Simple models → Rich, realistic systems
- Theory → Computational practice
:::
...
::: {.incremental}
- Practice visualization (use Python, Mathematica, Desmos 3D)
